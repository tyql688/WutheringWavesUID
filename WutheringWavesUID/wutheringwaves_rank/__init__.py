...
sv_waves_rank_refresh = SV(f'{PREFIX}刷新排行', priority=1, pm=1)
# sv_waves_rank_refresh_group = SV(f'{PREFIX}刷新群排行', pm=3)
...
@sv_waves_rank_refresh.on_fullmatch(f'{PREFIX}刷新全部排行', block=True)
