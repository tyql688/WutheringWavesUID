...
BASE_DATA_URL = f'{MAIN_URL}/gamer/roleBox/akiBox/baseData'
ROLE_DATA_URL = f'{MAIN_URL}/gamer/roleBox/akiBox/roleData'
CALABASH_DATA_URL = f'{MAIN_URL}/gamer/roleBox/akiBox/calabashData'
CHALLENGE_DATA_URL = f'{MAIN_URL}/gamer/roleBox/akiBox/challengeDetails'
CHALLENGE_INDEX_URL = f'{MAIN_URL}/gamer/roleBox/akiBox/challengeIndex'
EXPLORE_DATA_URL = f'{MAIN_URL}/gamer/roleBox/akiBox/exploreIndex'
SIGNIN_URL = f'{MAIN_URL}/encourage/signIn/v2'
ROLE_DETAIL_URL = f'{MAIN_URL}/gamer/roleBox/akiBox/getRoleDetail'
...
TOWER_INDEX_URL = f'{MAIN_URL}/gamer/roleBox/akiBox/towerIndex'
TOWER_DETAIL_URL = f'{MAIN_URL}/gamer/roleBox/akiBox/towerDataDetail'
